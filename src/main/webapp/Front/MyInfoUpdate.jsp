...
<body>
	<form action = "../Back/MyInfoUpdatePro.jsp" method = "post">
  		<label>
    		<p class="label-txt">아이디</p>
    		<input type="text" name="user_id" class="input" value=<%=model.getUser_id() %> readonly>
    		<div class="line-box">
      			<div class="line"></div>
    		</div>
  		</label>
		...
		<label>
			...
			<input type="text" name="user_name" class="input" value=<%=model.getUser_name() %>>
			<div class="line-box">
				<div class="line"></div>
			</div>
		</label>
		<label>
			...
			<input type="text" value="<%=model.getMail1() %>" size="8" name="mail1" class="mb-2 mr-2 border-0 btn-transition btn btn-outline-secondary">&nbsp; @ &nbsp;
		...
		<button type="button" onclick="location.href='mainPage.jsp?center=MyInfoUpdate.jsp'">초기화</button>
