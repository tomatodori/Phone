...
<body>
	<div class="user_join">
		<div class="user_title">
			<div class="heading">
				<span class='sub_title'>비밀번호 찾기</span>
			</div>
		</div>
		<div class="summary">
			비밀번호가 기억나지 않으십니까?<br /> 아래 해당하는 정보를 입력하시면 회원님의 비밀번호를 알려드립니다
		</div>
	</div>
	<form name="findpwForm" method="post" action="../Back/FindUser.jsp">
		<input type="hidden" name="find" value="user_pw" />
		<div class="user_title2">
			<div class="left">비밀번호 찾기</div>
		</div>
		<div class="list_box2">
			<fieldset>
				<legend>비밀번호 찾기</legend>
				<div class="item">
					<label class="head2" for="id">아이디</label>
					<div class="right">
						<input type="text" class="type-text"
							style="width: 180px; height: 17px;" id="id" name="user_id"
							title="아이디" value="" />
					</div>
				</div>
				<div class="item">
		...
		<div class="btn2">
			...
			<span class="button small black strong"> 
				<input type="button" class="" value="아이디찾기" onclick="location='mainPage.jsp?center=findID.jsp'" />
			</span>
		</div>
	</form>
</body>
